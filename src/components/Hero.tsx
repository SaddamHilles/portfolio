  ...
  return (
    <section className="relative overflow-hidden px-5 pt-28 pb-20 sm:px-8 sm:pt-36 sm:pb-28 lg:pt-40">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-[-12%] end-[-8%] h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,rgba(212,180,131,0.12),transparent_62%)]" />
        <div className="absolute bottom-[-20%] start-[-10%] h-[380px] w-[380px] rounded-full bg-[radial-gradient(circle,rgba(143,173,152,0.08),transparent_64%)]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          {t.hero.firstName}
          <br />
          <span className="italic text-accent">{t.hero.lastName}</span>
        </h1>
